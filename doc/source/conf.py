...
version = None
for line in codecs.open(os.path.join(root_path, 'updoc', '__init__.py'), 'r', encoding='utf-8'):
...
latex_documents = [
    ('index', 'updoc.tex', 'UpDoc!\'s Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'updoc', 'UpDoc!\'s documentation',
     [author], 1)
]
