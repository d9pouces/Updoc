...
As said before, Python is required but this is not the only requirement:
  ...
  * Python (3.5, 3.6, 3.7),
  * djangofloor>=1.1.0 Python package (automatically installed with UpDoc!),
  * elasticsearch>=2.0.0 Python package (automatically installed with UpDoc!),
  * requests Python package (automatically installed with UpDoc!),
  * markdown Python package (automatically installed with UpDoc!),
