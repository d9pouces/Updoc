...
BOOTSTRAP3 = {'jquery_url': '/static/js/jquery.min.js', 'base_url': '/static/bootstrap3/', 'javascript_url': None, 'horizontal_label_class': 'col-md-4', 'css_url': None, 'horizontal_field_class': 'col-md-8', 'theme_url': None}
...
DATABASES = {'default': {'AUTOCOMMIT': True, 'USER': '', 'ENGINE': 'django.db.backends.sqlite3', 'PORT': '', 'TEST': {'CHARSET': None, 'MIRROR': None, 'NAME': None, 'COLLATION': None}, 'PASSWORD': '', 'TIME_ZONE': 'UTC', 'ATOMIC_REQUESTS': False, 'HOST': '', 'OPTIONS': {}, 'NAME': '/Users/flanker/Developer/Github/DjangoFloor/django_data/data/database.sqlite3', 'CONN_MAX_AGE': 0}}
...
LOGGING = {'handlers': {'rotating_file': {'class': 'logging.handlers.RotatingFileHandler', 'backupCount': 2, 'maxBytes': 10000000, 'filename': '/Users/flanker/Developer/Github/DjangoFloor/django_data/log/django.log', 'level': 'INFO', 'encoding': 'utf-8', 'filters': ['require_debug_false']}, 'mail_admins': {'class': 'djangofloor.log.FloorAdminEmailHandler', 'filters': ['require_debug_false'], 'level': 'ERROR', 'min_interval': 600}}, 'version': 1, 'disable_existing_loggers': False, 'loggers': {'django.request': {'handlers': ['mail_admins'], 'propagate': True, 'level': 'ERROR'}}, 'filters': {'require_debug_false': {'()': 'django.utils.log.RequireDebugFalse'}}}
LOGIN_REDIRECT_URL = '/'
